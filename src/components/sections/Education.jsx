      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
            Education & <span className="text-gradient-editorial">Qualifications</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {educationData.map((edu, idx) => (
            <div
              key={idx}
              className="editorial-card p-8 flex flex-col justify-between group relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-28 h-28 bg-white/5 rounded-full blur-2xl group-hover:bg-white/10 transition-all pointer-events-none"></div>
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="px-3.5 py-1 rounded-full text-xs font-mono font-bold bg-zinc-900 border border-white/10 text-white">
                    {edu.period}
                  </span>
                </div>
                ...
                <div className="text-xs text-zinc-400 flex items-center gap-1 mb-4 font-mono">
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                <span className="text-xs font-mono text-zinc-400 font-bold">{edu.status}</span>
                
                <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-white text-zinc-950 font-black text-xs font-mono shadow-md">
