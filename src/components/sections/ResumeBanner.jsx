  ...
  return (
    <section className="py-16 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative editorial-card rounded-3xl p-8 sm:p-12 border border-white/20 overflow-hidden shadow-2xl bg-zinc-950">
          
          {/* Ambient Glow */}
          <div className="absolute -right-10 -bottom-10 w-72 h-72 bg-white/5 rounded-full blur-3xl pointer-events-none"></div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col items-center md:items-end gap-2 shrink-0">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full bg-white hover:bg-zinc-200 text-zinc-950 font-black text-sm shadow-2xl transition-all transform hover:-translate-y-0.5"
              >
                <FileText className="w-5 h-5" />
                <span>Download Resume</span>
                <ArrowUpRight className="w-4 h-4 ml-1" />
              </a>
              <span className="text-[11px] font-mono text-zinc-400 font-bold">PDF Format • Harigovind_P_Resume.pdf</span>
            </div>
          </div>
