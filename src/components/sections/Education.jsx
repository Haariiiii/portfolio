      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 text-slate-700 text-xs font-mono font-bold mb-2 uppercase tracking-wider shadow-sm">
            ...
            <span>ACADEMIC & SPECIALIZED EDUCATION</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {educationData.map((edu, idx) => (
            <div
              key={idx}
              className="minimal-card p-5 flex flex-col justify-between group bg-white border border-slate-200"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full text-[11px] font-mono font-bold bg-slate-100 border border-slate-200 text-slate-800">
                    {edu.period}
                  </span>
                </div>
                ...
                <div className="text-[11px] text-slate-500 flex items-center gap-1 mb-3 font-mono">
              ...
              <div className="pt-3 border-t border-slate-200 flex items-center justify-between">
                <span className="text-[11px] font-mono text-slate-500 font-bold">{edu.status}</span>
                
                <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-900 text-white font-bold text-xs font-mono shadow-sm">
