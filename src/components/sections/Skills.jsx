...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-20 md:py-28 relative">
      ...
      {/* Background Glow */}
      <div className="absolute top-1/2 right-1/4 w-96 h-96 bg-emerald-500/10 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
            Skills & <span className="text-gradient-emerald">Stack</span>
          </h2>
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-white/10">
                  ...
                  <span className="text-xs font-mono font-black text-slate-600">0{idx + 1}</span>
                </div>
                ...
                <div className="flex flex-wrap gap-2.5">
                  {category.skills.map((skill, sIdx) => (
                    <div
                      key={sIdx}
                      className="px-3.5 py-1.5 rounded-xl bg-slate-900 border border-white/10 hover:border-emerald-500/50 text-xs font-semibold text-slate-200 hover:text-emerald-300 transition-all flex items-center gap-2 shadow-sm"
                    >
              ...
              <div className="mt-6 pt-3 flex items-center justify-between text-[10px] font-mono text-slate-400 border-t border-white/5 font-bold">
