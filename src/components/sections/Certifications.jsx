      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
            Certifications & <span className="text-gradient-electric">Badges</span>
          </h2>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="p-3 rounded-2xl bg-slate-900 border border-white/10 text-emerald-400 group-hover:border-emerald-500/40 transition-colors">
                ...
                <div className="flex flex-wrap gap-1.5 mb-6">
                  {cert.skills.map((sk, sIdx) => (
                    <span
                      key={sIdx}
                      className="px-2.5 py-1 rounded-lg bg-slate-900 border border-white/10 text-[10px] font-mono text-slate-300"
                    >
                      {sk}
                    </span>
                  ))}
